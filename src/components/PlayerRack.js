...
function PlayerRack({ letters, moveLetter, playerIndex, myPlayerIndex, currentPlayerIndex, selectedLetter, onTapLetter, onTapSlot, isActionInProgress, isGameOver }) { // KLÚČOVÁ ZMENA: Pridaný isActionInProgress
